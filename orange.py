...
#### Config ####
################
attributes_names = filter(lambda x: x.startswith("phone2"), all_attributes) + ["outcome"]
save_path = os.path.join("results", "conv07 trees", "phone2")
tree_file_name = "phone2-all.dot" #will also save a .png with the same name
####################
#### End Config ####
####################
